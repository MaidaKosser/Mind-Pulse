      // Select all sections except the hero + their children
      document.querySelectorAll('section:not(#hero), .feature-card, .testimonial').forEach((el, index) => {
        el.setAttribute('data-aos', 'fade-up');        // animation type
        el.setAttribute('data-aos-duration', '1000');  // duration
        el.setAttribute('data-aos-delay', index * 200); // stagger delay
      });
